  ...
  return (
    <div className="border rounded-2xl p-4 shadow-lg flex justify-between gap-4 items-center bg-[#CADFFF]">
      ...
      <div className="space-y-4">
        <p className="text-gray-600 bg-[#E4E9F1] px-2 rounded-lg py-2">Name: {employee.name}</p>
        <p className="text-gray-600 bg-[#E4E9F1] px-2 rounded-lg py-2">Employee ID: {employee.employeeId}</p>
        <p className="text-gray-600 bg-[#E4E9F1] px-2 rounded-lg py-2">Email: {employee.email}</p>
        <p className="text-gray-600 bg-[#E4E9F1] px-2 rounded-lg py-2">Phone: {employee.phone}</p>
      </div>
    </div>
  );
};
