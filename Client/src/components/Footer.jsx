        ...
        <div className="flex w-11/12 mx-auto md:w-2/3 justify-between px-6">
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-center">
              ...
              <li>
                <a href="/team" className="hover:text-white text-gray-300">
                  Team
                </a>
              </li>
              ...
              <li>
                <a href="/portfolio" className="hover:text-white text-gray-300">
                  Portfolio
                </a>
              </li>
              <li>
                <a href="/career" className="hover:text-white text-gray-300">
                  Career
                </a>
              </li>
            </ul>
          ...
          <div className="text-center md:text-left">
            ...
            <p>
              Phone:{" "}
              <a href="tel:+919432323039" className="hover:text-gray-300">
                +91 9432323039
              </a>
            </p>
            <p>
