          ...
          <div className="md:w-1/2 mb-4 md:mt-6 text-center flex flex-col justify-center items-center">
            {imageURL ? (
              <img
                src={imageURL}
                alt="Profile"
                className="md:w-52 h-60 rounded-2xl mb-4 object-cover"
              />
            ) : (
            ...
            <button
              ...
              className="mt-2 bg-[#5846F9] text-white px-8 py-2 rounded-full"
            >
              Change
            </button>
          </div>
          ...
          <div className="md:w-1/2 flex justify-center items-center">
            <div className="bg-[#CADFFF] py-6 rounded-xl  flex flex-col gap-6 items-center px-4">
              <div className="space-y-4">
                <p className="text-lg bg-[#E4E9F1] px-5 rounded-lg py-2">
                  <strong>Name:</strong> {userDetails.name}
                </p>
                <p className="text-lg bg-[#E4E9F1] px-5 rounded-lg py-2">
                  <strong>Role:</strong> {userDetails.designation}
                </p>
                <p className="text-lg bg-[#E4E9F1] px-5 rounded-lg py-2">
