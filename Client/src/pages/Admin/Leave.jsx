    ...
    <div className="max-w-screen container mx-auto p-4 overflow-x-hidden min-h-screen">
      ...
      <div className="space-y-4 w-11/12 mx-auto">
        {leaves.map((leave) => (
          <div
            key={leave.id}
            className="flex justify-between items-center p-4 bg-[#CADFFF] rounded-lg shadow"
          >
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 md:w-1/2">
            ...
            <div className="space-y-5">
              <p className="bg-[#CADFFF] py-2 px-2 mx-8 rounded-lg text-center">
                <strong>Reason:</strong> {selectedLeave.reason}
              </p>
              <div className="flex gap-6 px-8">
                <p className="bg-[#CADFFF] w-1/2 py-2 px-2 rounded-lg text-center">
            ...
            <div className="flex justify-between w-7/12 mx-auto space-x-4 mt-6">
              <button
                onClick={() =>
                  handleStatusChange("approved", selectedLeave._id)
                }
                className="px-8 py-2 bg-[#5846F9] text-white rounded-full hover:bg-[#422ef4]"
              >
                Accept
              ...
              <button
                onClick={() =>
                  handleStatusChange("rejected", selectedLeave._id)
                }
                className="px-8 py-2 bg-[#5846F9] text-white rounded-full hover:bg-[#422ef4]"
              >
                Reject
